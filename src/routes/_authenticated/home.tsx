...
const APPS = [
  ...
  { to: "/billing-scheduler", label: "Billing Scheduler", icon: CalendarClock, from: "#8b5cf6", toColor: "#d946ef" },
  { to: "/services", label: "Service Master", icon: Package, from: "#0891b2", toColor: "#0e7490" },
